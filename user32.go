...
var (
	...
	getCursorInfo               *windows.LazyProc
...
func init() {
	...
	getCursorInfo = libuser32.NewProc("GetCursorInfo")
...
func GetCursorInfo(lpCursorInfo *CURSORINFO) bool {
	ret, _, _ := syscall.Syscall(getCursorInfo.Addr(), 1,
		uintptr(unsafe.Pointer(lpCursorInfo)),
		0,
		0)
